...
hl.bind(mainMod .. " + ALT + LEFT", hl.dsp.window.move({ into_group = true, direction = "l" }),
  { description = "Move window to group on left" })
hl.bind(mainMod .. " + ALT + RIGHT", hl.dsp.window.move({ into_group = true, direction = "r" }),
  { description = "Move window to group on right" })
hl.bind(mainMod .. " + ALT + UP", hl.dsp.window.move({ into_group = true, direction = "u" }),
  { description = "Move window to group on top" })
hl.bind(mainMod .. " + ALT + DOWN", hl.dsp.window.move({ into_group = true, direction = "d" }),
