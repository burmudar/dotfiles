...
let
  sources = {
    ...
    "@puppeteer/browsers-2.12.0" = {
      ...
      version = "2.12.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@puppeteer/browsers/-/browsers-2.12.0.tgz";
        sha512 = "Xuq42yxcQJ54ti8ZHNzF5snFvtpgXzNToJ1bXUGQRaiO8t+B6UM8sTUJfvV+AJnqtkJU/7hdy6nbKyA12aHtRw==";
      };
    };
    ...
    "chromium-bidi-13.1.1" = {
      ...
      version = "13.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/chromium-bidi/-/chromium-bidi-13.1.1.tgz";
        sha512 = "zB9MpoPd7VJwjowQqiW3FKOvQwffFMjQ8Iejp5ZW+sJaKLRhZX1sTxzl3Zt22TDB4zP0OOqs8lRoY7eAW5geyQ==";
      };
    };
    "ci-info-2.0.0" = {
      name = "ci-info";
    ...
    "puppeteer-24.37.2" = {
      ...
      version = "24.37.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/puppeteer/-/puppeteer-24.37.2.tgz";
        sha512 = "FV1W/919ve0y0oiS/3Rp5XY4MUNUokpZOH/5M4MMDfrrvh6T9VbdKvAHrAFHBuCxvluDxhjra20W7Iz6HJUcIQ==";
      };
    };
    "puppeteer-core-24.37.2" = {
      ...
      version = "24.37.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/puppeteer-core/-/puppeteer-core-24.37.2.tgz";
        sha512 = "nN8qwE3TGF2vA/+xemPxbesntTuqD9vCGOiZL2uh8HES3pPzLX20MyQjB42dH2rhQ3W3TljZ4ZaKZ0yX/abQuw==";
      };
    };
    ...
    "webdriver-bidi-protocol-0.4.0" = {
      ...
      version = "0.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/webdriver-bidi-protocol/-/webdriver-bidi-protocol-0.4.0.tgz";
        sha512 = "U9VIlNRrq94d1xxR9JrCEAx5Gv/2W7ERSv8oWRoNe/QYbfccS0V3h/H6qeNeCRJxXGMhhnkqvwNrvPAYeuP9VA==";
      };
    };
...
in
{
  ...
  "@browsemake/browser-cli" = nodeEnv.buildNodePackage {
    name = "_at_browsemake_slash_browser-cli";
    packageName = "@browsemake/browser-cli";
    version = "0.1.64";
    src = fetchurl {
      url = "https://registry.npmjs.org/@browsemake/browser-cli/-/browser-cli-0.1.64.tgz";
      sha512 = "fV2uTSeZL218ROl335M+VbNfeSyW9iR+cbzHPYN/NZpWmCStIiD+rE6h2X3NQSMzhjqKCrYn10IxgcnNaM+uNw==";
    };
    dependencies = [
      ...
      (sources."@puppeteer/browsers-2.12.0" // {
        dependencies = [
          sources."debug-4.4.3"
        ];
      })
      ...
      sources."baseline-browser-mapping-2.9.19"
      ...
      sources."caniuse-lite-1.0.30001769"
      sources."chalk-4.1.2"
      ...
      sources."electron-to-chromium-1.5.286"
      ...
      sources."pump-3.0.3"
      sources."puppeteer-24.37.2"
      (sources."puppeteer-core-24.37.2" // {
        dependencies = [
          sources."debug-4.4.3"
          sources."ws-8.19.0"
        ];
      ...
      sources."webdriver-bidi-protocol-0.4.0"
    ...
    buildInputs = globalBuildInputs;
    meta = {
      description = "<p align=\"center\">   <img width=\"full\" src=\"https://github.com/user-attachments/assets/ac1cd9e3-f811-4af7-9338-7d6d0c80fcd7\" /> </p>";
    };
    production = true;
    bypassCache = true;
    reconstructLock = true;
